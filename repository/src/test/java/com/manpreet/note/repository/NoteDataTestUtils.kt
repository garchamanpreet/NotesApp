...
internal class NoteDataTestUtils {
    
    private val noteTableOne = NoteTable(0,"testTitle_One",Priority.HIGH_PRIORITY,"testing description")
    private val noteTableTwo = NoteTable(0,"testTitle_Two",Priority.LOW_PRIORITY,"testing description two ")
